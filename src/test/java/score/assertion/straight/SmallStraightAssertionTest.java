...
class SmallStraightAssertionTest {

  private static SmallStraightAssertion smallStraightAssertion;

  @BeforeAll
  static void init() {
    smallStraightAssertion = new SmallStraightAssertion();
  }
  ...
  class WhenIsCheckedIsCalled {
    ...
    void should_check_if_it_has_combination_in_hand(
      ...
      // WHEN
      boolean result = smallStraightAssertion.isChecked(hand);
