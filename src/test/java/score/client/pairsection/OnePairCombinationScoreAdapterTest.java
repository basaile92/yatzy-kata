...
class OnePairCombinationScoreAdapterTest {

  private static OnePairCombinationScoreAdapter onePairCombinationScoreAdapter;

  @BeforeAll
  static void init() {
    onePairCombinationScoreAdapter = new OnePairCombinationScoreAdapter();
  }
  ...
  class WhenComputeIsCalled {
    ...
    void should_return_expected_score_with_hand(Hand hand, int expectedScore) {
      // WHEN
      int score = onePairCombinationScoreAdapter.compute(hand);
