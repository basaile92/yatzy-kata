...
class TwoPairsCombinationScoreAdapterTest {

  private static TwoPairsCombinationScoreAdapter twoPairsCombinationScoreAdapter;

  @BeforeAll
  static void init() {
    twoPairsCombinationScoreAdapter = new TwoPairsCombinationScoreAdapter();
  }
  ...
  class WhenComputeIsCalled {
    ...
    void should_return_expected_score_with_hand(Hand hand, int expectedScore) {
      // WHEN
      int score = twoPairsCombinationScoreAdapter.compute(hand);
