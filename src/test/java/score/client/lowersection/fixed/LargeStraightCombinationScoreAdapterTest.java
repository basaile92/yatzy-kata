...
class LargeStraightCombinationScoreAdapterTest {

  private static LargeStraightCombinationScoreAdapter largeStraightCombinationScoreAdapter;
  ...
  class WhenComputeIsCalled {
    ...
    void should_return_expected_score_with_hand(Hand hand, int expectedScore) {
      // WHEN
      int score = largeStraightCombinationScoreAdapter.compute(hand);
