...
class SixesCombinationScoreAdapterTest {

  private static SixesCombinationScoreAdapter sixesCombinationScoreAdapter;

  @BeforeAll
  static void init() {
    sixesCombinationScoreAdapter = new SixesCombinationScoreAdapter();
  }
  ...
  class WhenComputeIsCalled {
    ...
    void should_return_expected_score_with_hand(Hand hand, int expectedScore) {
      // WHEN
      int score = sixesCombinationScoreAdapter.compute(hand);
